...
| `dispatched-agent-stop-guard.py` | Claude / Antigravity Stop hook | Block an in-progress dispatched session from ending a turn without a durable checkpoint or terminal report; non-dispatched sessions are unaffected |
