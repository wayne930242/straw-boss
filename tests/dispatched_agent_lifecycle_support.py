...
class DispatchedAgentLifecycleFixture:
    ...
    def install_fake_herdr(self) -> tuple[Path, Path]:
        ...
        fake_herdr.write_text(
            ...
            "    default_processes = [{'pid': os.getppid()}] if os.environ.get('HERDR_PROCESS_INFO_CALLER') == '1' else []\n"
            "    print(json.dumps({'result': {'process_info': process_infos.get(target, {'pane_id': target, 'foreground_processes': default_processes})}}))\n"
